...
// Register user
export const registerAgent = createAsyncThunk("/espaceAgent/Admin/register", async (user, thunkAPI) => {
  try {
...
// login user
export const loginAgent = createAsyncThunk("/espaceAgent/login", async (user, thunkAPI) => {
  try {
